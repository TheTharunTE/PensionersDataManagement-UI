		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Object Page",
									"targetURL": "#techenvoobjectpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"techenvoobjectpage-display": {
								"semanticObject": "techenvoobjectpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=techenvo.objectpage",
									"url": sap.ui.require.toUrl("techenvo/objectpage")
								}
							}
						}
					}
